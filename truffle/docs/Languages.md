...
* [streamblocks-graalvm](https://github.com/streamblocks/streamblocks-graalvm), an implementation of [CAL Actor Language](https://en.wikipedia.org/wiki/CAL_Actor_Language), a [Dataflow Programming](https://en.wikipedia.org/wiki/Dataflow_programming) Language
